...
<head>
    ...
    <meta name="description" content="RSS Procer - Modo de Invitado.">
    <meta name="robots" content="noindex,nofollow">

    <title>:: Invitado - RSS Procer::</title>
    ...
    <!-- CSS -->
    <link rel="stylesheet" class="link-theme-file" href="<?= $Hp_View->getCss("themes/default.min.css"); ?>">
