...
* Example usage:
* @code
* require_once 'Readability_JSLikeHTMLElement.php';
* header('Content-Type: text/plain');
* $doc = new DOMDocument();
* $doc->registerNodeClass('DOMElement', 'Readability_JSLikeHTMLElement');
...
*/
class Readability_JSLikeHTMLElement extends DOMElement
{
	/**
